        ...
        <div className="header__container">
                ...
                <svg version="1.1" id="el_EG_L-xfsQ" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 343 109" style="enable-background:new 0 0 343.8 109.2;" xml:space="preserve">
                  ...
                  <g id="el_EBF_DusqDD">
                      <g id="el_LEX7Ce3qmw">
                          ...
                          <g id="el_eDBw9T6cG8">
                              <linearGradient id="background_5_" gradientUnits="userSpaceOnUse" x1="0" y1="54.6138" x2="343.8213" y2="54.6138">
                  ...
                  <g id="el_48PPAv7E_6">
                      <g id="el_R2y2-foFri">
                          ...
                          <g id="el_1iFGezowkW">
                              <linearGradient id="background_6_" gradientUnits="userSpaceOnUse" x1="9.0806" y1="54.614" x2="334.7398" y2="54.614">
                                  <stop offset="0" style="stop-color:#EC6E66"/>
                                  <stop offset="1" style="stop-color:#F3A183"/>
                              </linearGradient>
          ...
          <div className="header__actions">
            <button id="headerMenuButton" className="header__menu-button">
              <!--<span className="svgstore svgstore--menu">
                <svg aria-label="menu" role="img" >
                  <title>header menu</title>
                  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/assets/svg/svgstore.svg#menu"></use>
                </svg>
              </span>-->
              <svg className="svg-menu" aria-hidden="true" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 100">
                <title>Menu</title>
