  ...
  render(){
    return (
      <main id="main" className="main project">
        <section className="section section--project-banner project__section fadein">
        ...
        <section className="section section--horizontal-scroll project__section fadein">
        ...
        <section className="section section--text-block section--jesuit-bg  project__section fadein">
          <div className="section__container">
        ...
        <section className="section section--mockup project__section fadein">
        ...
        <section className="section section--text-block section--rays-bg project__section fadein">
          <div className="section__container">
        ...
        <section className="section section--project-media project__section fadein">
        ...
        <section className="section section--media-responsive fadein">
