  ...
  render(){
    return (
      <main id="main" className="main project">
        ...
        <section className="section section--media-grid project__section fadein">
        ...
        <section className="section section--media-cards project__section fadein">
        ...
        <section className="section section--mobile-device project__section fadein">
